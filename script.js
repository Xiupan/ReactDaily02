...
class Factory {
  ...
  massBuild(quantity, color, trim, model){
    console.log(`Building ${quantity} ${color} ${trim} ${model}'s`);
  }
  customerBuild(color, trim, model, options){
...
// Write your code below:
// model, doors, color, enginetype, transmission, trim, wheelstrim, audio, seatstrim, moonroof, warranty
const mazda3 = new Car("Mazda 3",4,"Red","Hybrid","automatic","touring","base","premium","leather",true)
console.log(mazda3);
...
// Write your code below:
miataRf.massBuild(15000,"Red","Grand Touring","Miata-RF")
...
// Write your code below:
// customerBuild(color, trim, model, options)
miataRf.customerBuild("black","Grand Touring","Miata-RF","hid headlights, sports suspension, leather steering wheel, heated seats, adaptive cruise control")
...
// Write your code below:
// constructor(model, color, enginesize, hitch, bed, navigation, warranty)
const trailBlazer = new Truck("Trail Blazer","blue",8,true,"standard",true)
...
trailBlazer.massBuild(35000,"blue","Sport","Trail Blazer")
...
// Write your code below:
trailBlazer.customerBuild("red","Sport","Trail Blazer",["seat warmers"," tinted windows"," fog lamps"])
